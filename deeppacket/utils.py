...
def get_args():
    ...
    parser.add_argument("-m", "--mode", help="trainer mode [train/test]", dest="mode", default="train-test")
    parser.add_argument("-n", "--name", help="model name [model]", dest="model_name", default="cnn")
